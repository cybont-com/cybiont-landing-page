...
export function PreviewPanel() {
  return (
    <div className="relative bg-white border-l-neutral-200 flex basis-[0%] flex-col grow overflow-hidden border-r-black/90 border-y-black/90 border-l">
      <div className="relative items-center bg-white border-b-neutral-200 flex h-8 justify-between p-2 border-t-black/90 border-x-black/90 border-b">
        <div className="items-center gap-x-1 flex basis-0 grow justify-start gap-y-1">
          <button aria-label="Refresh preview" type="button" className="text-black items-center bg-transparent grid h-8 justify-items-center outline-transparent -outline-offset-1 outline outline-1 w-8 p-0 rounded-[5px]">
                                ...
                                <div className="relative bg-white flex flex-col h-full w-full">
                                  <div className="relative h-full w-full">
                                    <div className="absolute box-border flex inset-0">
                                      <iframe 
                                        title="Preview" 
                                        src="https://d7fea12f-3b54-4b0d-9413-f0e262a69c0d-figmaiframepreview.figma.site/preview_page.html" 
